...
#define FFMPEG_CONFIGURATION "--prefix=/tmp/ffmpeg-build --enable-debug=3 --disable-doc --enable-static --disable-shared --pkg-config-flags=--static --disable-optimizations --extra-cflags=-Og --disable-asm"
